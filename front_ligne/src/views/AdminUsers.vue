	...
	methods: {
		...
		seeAllUsers: function() {
			...
			if (!this.logged) {
				...
				axios({
					method: "get",
					url: "https://apiresomouto.delmout.com/api/auth/users",
					headers: {
		...
		createUser: function() {
			...
			axios({
				method: "post",
				url: "https://apiresomouto.delmout.com/api/auth/signup",
				data: formData,
				headers: {
					Authorization: `Bearer ${this.token}`,
				},
				...
				.then((resp) => {
					...
					axios({
						method: "post",
						url:
							"https://apiresomouto.delmout.com/api/auth/emailpassword/" +
							this.prenom +
							"/first",
					})
						.then((resp) => {
		...
		demandModifUser: function(user) {
			...
			if (!this.logged) {
				...
				axios({
					method: "get",
					url: "https://apiresomouto.delmout.com/api/auth/modif/" + user.index,
					headers: {
						Authorization: `Bearer ${this.token}`,
					},
				})
		...
		modifUser: function() {
			...
			if (!this.logged) {
				...
				axios({
					method: "put",
					url: "https://apiresomouto.delmout.com/api/auth/modif/" + this.userIndex,
					data: formData,
					headers: {
						Authorization: `Bearer ${this.token}`,
					},
		...
		confDeleteUser: function(user) {
			...
			if (!this.logged) {
				...
				axios({
					method: "delete",
					url: "https://apiresomouto.delmout.com/api/auth/delete/" + user.index,
					headers: {
						Authorization: `Bearer ${this.token}`,
					},
				})
		...
		findByEmail: function() {
			...
			if (!this.logged) {
				...
				axios({
					method: "get",
					url: "https://apiresomouto.delmout.com/api/auth/find/" + this.emailReq,
					headers: {
						Authorization: `Bearer ${this.token}`,
					},
				})
